        ...
        <div className="fixed flex items-center justify-center top-0 right-0 bottom-0 left-0 z-20 bg-blue-dark">
            <div className="flex flex-col items-center">
                ...
                <p className="text-base font-normal text-gray-middle w-2/5 text-center my-8">
                    Receio que você não tenha encontrado a página que procurava.
                    Isso pode acontecer quando você insere dados na url e/ou não
                    exista ou já foi excluído. Ou algum link que estava
                    incorreto.
                </p>
                <Link
                    href="/"
